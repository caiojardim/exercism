...
export function decodedResistorValue(colorsArray: Color[]): string {
  const parsedNumber = Number(COLORS[colorsArray[0]] + COLORS[colorsArray[1] ] + "0".repeat(Number(COLORS[colorsArray[2] ])))
